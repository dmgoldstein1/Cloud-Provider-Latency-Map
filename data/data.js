(function () {
  var D = window.VML_DATA = window.VML_DATA || {};
  D.measured = {
  "source": "measured via netlat.sh (phased all-pairs run 2026-08-10)",
...
;
  D.regions = {
  "source": "GeoNames (public domain), merged with Vultr region list",
  "regions": [
    {
      "code": "ams",
      "name": "Amsterdam",
